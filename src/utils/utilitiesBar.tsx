export const UtilityBar = () => {
  return <div className="min-h-screen w-fit rounded-e-xl p-0 text-gray-900 ">
  <div className="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-white">
